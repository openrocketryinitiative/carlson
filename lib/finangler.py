...
class FinAngler():
    """Angle rocket canards to keep it stable in flight.

    Given the roll and pitch of the rocket, this code generates commands to be 
    applied to the servos to stabilize the rockets attitude.
    """
    ...
    def calc_angles(self, push_angle, force, spin):
        ...
        Inputs:
            ...
            spin        --  the amount of yaw force around the long axis to be 
                            applied
        """
        ...
        # The component of each fins force that is out of axis with the desired 
        # force.
    ...
    def forces_to_angles(self, forces):
        """Take an array of fin forces and return an array of fin angles to 
        generate those forces. 

        TODO:   This will need to be updated with a more advanced model 
                incorporating fin AOA in the future.
        """
        return np.arcsin(forces/(self.velocity**2)) / np.pi * 180.


if __name__ == '__main__':
    """Test FinAngler class.
    """
